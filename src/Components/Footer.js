        ...
        <div><footer className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    ...
                    <p className="mt-2 text-sm text-gray-500">Premium everything you want store available</p>
                </div>
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Zippper Hoodies</a>
                            </li>
                            <li>
                    ...
                    <div className="lg:w-1/4 flex items-center justify-center w-full px-4"><nav className="list-none mb-10 dark:text-gray-300 w-60">
                    <Image src="https://www.codeswear.com/pay.png" width={200} height={50} alt='' />
